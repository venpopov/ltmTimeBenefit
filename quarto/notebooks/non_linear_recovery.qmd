...
shinyApp(
  ui = fluidPage(
    ...
    sidebarLayout(
      sidebarPanel(
        ...
        sliderInput("gain", "gain:", min = 1, max = 100, value = 62),
  ...
  server = function(input, output) {
    output$distPlot <- renderPlot({
      ...
      data |>
        mutate(
          Probability = predict_resmodel(par, data = data, group_by = c("gap", "chunk"), growth = "asy"),
          Strength = predict_resmodel(par, data = data, group_by = c("gap", "chunk"), type = "strength", growth = "asy")
        ) |>
